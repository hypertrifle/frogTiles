...
::haxe::io::Bytes ArrayBuffer_Impl__obj::_new( int byteLength){
	HX_STACK_FRAME("snow.api.buffers._ArrayBuffer.ArrayBuffer_Impl_","_new",0x9fd11d90,"snow.api.buffers._ArrayBuffer.ArrayBuffer_Impl_._new","snow/api/buffers/ArrayBuffer.hx",13,0x87ad6cc2)
