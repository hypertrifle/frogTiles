...
bool MatrixTransform_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void MatrixTransform_obj::__register()
{
	...
	__mClass->mSetStaticField = &MatrixTransform_obj::__SetStatic;
