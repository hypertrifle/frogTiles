...
::String Path_obj::join( Array< ::String > paths){
	HX_STACK_FRAME("haxe.io.Path","join",0x05c781f3,"haxe.io.Path.join","/usr/lib/haxe/std/haxe/io/Path.hx",189,0xf85ee938)
	HX_STACK_ARG(paths,"paths")

	HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_Function_1_1)
	int __ArgCount() const { return 1; }
	bool run(::String s){
		HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","/usr/lib/haxe/std/haxe/io/Path.hx",190,0xf85ee938)
		HX_STACK_ARG(s,"s")
		{
			HX_STACK_LINE(190)
...
::String Path_obj::normalize( ::String path){
	HX_STACK_FRAME("haxe.io.Path","normalize",0x585a68e4,"haxe.io.Path.normalize","/usr/lib/haxe/std/haxe/io/Path.hx",210,0xf85ee938)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(211)
