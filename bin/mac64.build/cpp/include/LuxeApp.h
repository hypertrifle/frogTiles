...
class HXCPP_CLASS_ATTRIBUTES  LuxeApp_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=false,const char *inName="LuxeApp")
		...
		::String __ToString() const { return HX_HCSTRING("LuxeApp","\x6b","\x56","\x2a","\x7b"); }

		static ::Main _game;
		static ::luxe::Core _core;
		static ::snow::Snow _snow;
		static Dynamic _conf;
		static Void main( );
