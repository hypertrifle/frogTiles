...
virtual ::luxe::tween::actuators::IGenericActuator onComplete( Dynamic handler,cpp::ArrayBase parameters) { return mDelegate->onComplete(handler,parameters);}  \
virtual Dynamic onComplete_dyn() { return mDelegate->onComplete_dyn();}  \
virtual ::luxe::tween::actuators::IGenericActuator onRepeat( Dynamic handler,cpp::ArrayBase parameters) { return mDelegate->onRepeat(handler,parameters);}  \
virtual Dynamic onRepeat_dyn() { return mDelegate->onRepeat_dyn();}  \
virtual ::luxe::tween::actuators::IGenericActuator onUpdate( Dynamic handler,cpp::ArrayBase parameters) { return mDelegate->onUpdate(handler,parameters);}  \
