...
#define INCLUDED_snow_system_input_Scancodes

#ifndef HXCPP_H
#include <hxcpp.h>
#endif

HX_DECLARE_CLASS3(snow,_system,input,Scancodes)
namespace snow{
namespace _system{
namespace input{
...
class HXCPP_CLASS_ATTRIBUTES  Scancodes_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=false,const char *inName="snow.system.input.Scancodes")
...
#endif /* INCLUDED_snow_system_input_Scancodes */ 
