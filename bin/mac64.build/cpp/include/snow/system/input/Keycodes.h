...
#define INCLUDED_snow_system_input_Keycodes

#ifndef HXCPP_H
#include <hxcpp.h>
#endif

HX_DECLARE_CLASS3(snow,_system,input,Keycodes)
namespace snow{
namespace _system{
namespace input{
...
class HXCPP_CLASS_ATTRIBUTES  Keycodes_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=false,const char *inName="snow.system.input.Keycodes")
...
#endif /* INCLUDED_snow_system_input_Keycodes */ 
