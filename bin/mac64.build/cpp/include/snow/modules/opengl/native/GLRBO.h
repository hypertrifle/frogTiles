...
#define INCLUDED_snow_modules_opengl_native_GLRBO
...
class HXCPP_CLASS_ATTRIBUTES  GLRBO_obj : public ::snow::modules::opengl::native::GLObject_obj{
	public:
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=false,const char *inName="snow.modules.opengl.native.GLRBO")
		...
		::String __ToString() const { return HX_HCSTRING("GLRBO","\x9a","\xd9","\xed","\x13"); }
...
#endif /* INCLUDED_snow_modules_opengl_native_GLRBO */ 
