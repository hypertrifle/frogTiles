...
#define INCLUDED_snow_modules_openal_AL
...
HX_DECLARE_CLASS3(snow,modules,openal,AL)
namespace snow{
namespace modules{
namespace openal{
...
class HXCPP_CLASS_ATTRIBUTES  AL_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=false,const char *inName="snow.modules.openal.AL")
		...
		static Void bufferData( int buffer,int format,::snow::api::buffers::ArrayBufferView data,int frequency);
...
#endif /* INCLUDED_snow_modules_openal_AL */ 
